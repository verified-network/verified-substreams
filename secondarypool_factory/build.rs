...
fn main() -> Result<(), anyhow::Error> {
    let file_names = [
        "abi/secondarypool_factory_contract.abi.json",
        "abi/secondary_pool_contract.abi.json",
    ];
    let file_output_names = [
        "src/abi/secondarypool_factory_contract.rs",
        "src/abi/secondary_pool_contract.rs",
    ];
