...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetMargin {}
    impl GetMargin {
        const METHOD_ID: [u8; 4] = [37u8, 17u8, 123u8, 114u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetMargin {
        const NAME: &'static str = "getMargin";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl GetOrderbook {
        const METHOD_ID: [u8; 4] = [171u8, 99u8, 198u8, 7u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetOrderbook {
        const NAME: &'static str = "getOrderbook";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetOrderbook {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MarginOffer {
        pub security: Vec<u8>,
        pub security_type: [u8; 32usize],
        pub min_order_size: substreams::scalar::BigInt,
        pub currency: Vec<u8>,
        pub margin: substreams::scalar::BigInt,
        pub collateral: substreams::scalar::BigInt,
        pub cfi_code: [u8; 32usize],
    ...
    impl substreams_ethereum::Event for MarginOffer {
        const NAME: &'static str = "MarginOffer";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    pub struct MarginOrderBook {
        ...
        pub stoploss_price: substreams::scalar::BigInt,
    ...
    impl substreams_ethereum::Event for MarginOrderBook {
        const NAME: &'static str = "MarginOrderBook";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for MarginTradeReport {
        const NAME: &'static str = "MarginTradeReport";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
